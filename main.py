...
serverPort = 9999  # Порт для доступа по сети
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-success form-control">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <form>
                        ...
                        <button type="button" class="btn btn-success form-control">Отправить</button>
                    </form>
                </div>
